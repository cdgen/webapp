...
class SlideShow extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={"slider " + this.state.anmState}>
        <div className="slider-wrap" style={styles}>
          { items }
        </div>
  ...
  renderItem(item, current, index) {
    return <CarouselItem {...item} current={current} count={index}></CarouselItem> 
  }
  ...
  renderDot(item, current, index) {
    return <Dot {...item} current={current} target={index} onClick={this.switcherTo} ></Dot>  
  }
...
class Dot extends React.Component {
  render() {
    ...
    return (
      <div className={"slider-dot " + (this.props.current ? 'active':'' )} data-target={this.props.target} onClick={this.props.onClick} style={styles}>
